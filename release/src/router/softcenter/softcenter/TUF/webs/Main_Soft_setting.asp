								...
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
                                    	...
                                    	<div id="log_content" style="margin-top:10px;display: block;">
											<textarea cols="63" rows="15" wrap="off" readonly="readonly" id="log_content1" style="width:99%; font-family:'Lucida Console'; font-size:12px;background:transparent;border:1px solid #92650F;color:#FFFFFF;"></textarea>
										</div>
