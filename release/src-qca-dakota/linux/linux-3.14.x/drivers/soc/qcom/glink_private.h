 ...
 */
#ifndef _SOC_QTI_GLINK_PRIVATE_H_
#define _SOC_QTI_GLINK_PRIVATE_H_
...
#define GLINK_DBG(x...) do {                              \
	if (glink_get_debug_mask() & QTI_GLINK_DEBUG) \
			GLINK_IPC_LOG_STR(x);  \
} while (0)

#define GLINK_INFO(x...) do {                              \
	if (glink_get_debug_mask() & QTI_GLINK_INFO) \
			GLINK_IPC_LOG_STR(x);  \
} while (0)

#define GLINK_INFO_PERF(x...) do {                              \
	if (glink_get_debug_mask() & (QTI_GLINK_INFO | QTI_GLINK_PERF)) \
			GLINK_IPC_LOG_STR(x);  \
} while (0)

#define GLINK_PERF(x...) do {                              \
	if (glink_get_debug_mask() & QTI_GLINK_PERF) \
...
#endif /* _SOC_QTI_GLINK_PRIVATE_H_ */
