...
checkentry(const struct xt_mtchk_param *par)
{
...
#if 1
	 newvar->status_proc = proc_create(info->name, condition_list_perms, proc_net_condition,&x_fops);
#else
	...
	newvar->status_proc->uid.val = condition_uid_perms;
	newvar->status_proc->gid.val = condition_gid_perms;
