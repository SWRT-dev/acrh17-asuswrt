...
extern int skb_recycler_notifier_register(struct notifier_block *nb);
extern int skb_recycler_notifier_unregister(struct notifier_block *nb);
extern int skb_recycler_notifier_send_event(unsigned long action,
					    struct sk_buff *skb);
#else
