...
#define CONFIG_HAVE_LP5523_LEDS
...
#define CONFIG_BOOTFILE		CONFIG_MODEL ".trx"
...
#define CFG_UBI_FIRMWARE_NR_LEB		290	/* 124KB x 290 = 35.1MB */
#define CFG_UBI_FIRMWARE2_NR_LEB	290
#define CFG_UBI_APP_NR_LEB		392	/* 124KB x 392 = 47.5MB */
